...
import v3.createAmend.def1.fixtures.Def1_CreateAmendOtherFixtures.{
  requestBodyModel,
  requestBodyWithPCRJson,
  postCessationReceiptsItemJson,
  businessReceiptsJson,
  allOtherIncomeReceivedWhilstAbroadJson,
  overseasIncomeAndGainsJson,
  chargeableForeignBenefitsAndGiftsJson,
  omittedForeignIncomeJson
}
